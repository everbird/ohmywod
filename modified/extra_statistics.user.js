...
(function() {
    ...
    function GetStatPage() {
        var queryString = $("form[name='the_form']").serialize() + "&IS_POPUP=1&" + gCurrentReport.getAttribute(rValue.Text_Stat) + "=" + rValue.Text_Stat;
        var XmlHttp = new XMLHttpRequest();
    ...
    function GetItemPage() {
        var queryString = $("form[name='the_form']").serialize() + "&IS_POPUP=1&" + gCurrentReport.getAttribute(rValue.Text_Item) + "=" + rValue.Text_Item;
        var XmlHttp = new XMLHttpRequest();
